...
run_main_aug.sh
	...
	The first volume mapping (-v /mnt/ngv/askc-home/SensorTransfer_datasets/GTA_all21k_final/VOC2012/JPEGImages, line 2) 
	argument is the full path to the directory that holds the images you would like to augment.
	The second volume mapping (-v `pwd`/augFIGURES:/root/ResultsDir, line 3) is the path to the directory where the augmented images will be saved.
	The other volume mappings are setting up the file system in the container. 
